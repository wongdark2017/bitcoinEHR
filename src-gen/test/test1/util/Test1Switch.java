...
public class Test1Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Test1Package.HYPER_LEDGER: {
			HyperLedger hyperLedger = (HyperLedger) theEObject;
			T result = caseHyperLedger(hyperLedger);
			if (result == null)
		...
		case Test1Package.USER: {
			...
			if (result == null)
				result = caseDoctor(user);
			if (result == null)
				result = casePatient(user);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Hyper Ledger</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Hyper Ledger</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHyperLedger(HyperLedger object) {
		return null;
	}
